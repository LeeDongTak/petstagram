...
import MasterPorfile from '../Addporfile/MasterPorfile';
import PetProfile from '../Addporfile/PetProfile';
...
function EditProfile() {
  ...
  const profileAddHandler = (id, e, navigate) => {
    dispatch(profileEditCommit({ id, e, navigate }));
  };
  return (
    <StAddProfileWrap>
      ...
      <StAddProfileContainer>
        <StAddProfileHeaderBox>
          <StAddProFiletitle $title="title1">프로필 수정</StAddProFiletitle>
          <StAddBtn
            onClick={(e) => {
